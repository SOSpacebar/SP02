...
void Assignment03::Init()
{
	...
	//meshList[GEO_MODEL1] = MeshBuilder::GenerateOBJ("model1", "OBJ//Assignment03//Arc170.obj");
	//meshList[GEO_MODEL1]->textureID = LoadTGA("Image//Assignment03//Arc170_blinn1.tga");

	//meshList[GEO_MODEL2] = MeshBuilder::GenerateOBJ("model2", "OBJ//Assignment03//LightSaber.obj");
	//meshList[GEO_MODEL2]->textureID = LoadTGA("Image//Assignment03//metalTexture.tga");

	//meshList[GEO_ROCK1] = MeshBuilder::GenerateOBJ("rock1", "OBJ//Assignment03//stone1.obj");
	//meshList[GEO_ROCK1]->textureID = LoadTGA("Image//Assignment03//snowRocks.tga");
	//meshList[GEO_ROCK2] = MeshBuilder::GenerateOBJ("rock2", "OBJ//Assignment03//stone2.obj");
	//meshList[GEO_ROCK2]->textureID = LoadTGA("Image//Assignment03//snowRocks.tga");
	//meshList[GEO_ROCK3] = MeshBuilder::GenerateOBJ("rock3", "OBJ//Assignment03//stone3.obj");
	//meshList[GEO_ROCK3]->textureID = LoadTGA("Image//Assignment03//snowRocks.tga");
	//meshList[GEO_ROCK4] = MeshBuilder::GenerateOBJ("rock4", "OBJ//Assignment03//stone4.obj");
	//meshList[GEO_ROCK4]->textureID = LoadTGA("Image//Assignment03//snowRocks.tga");
	//meshList[GEO_ROCK5] = MeshBuilder::GenerateOBJ("rock5", "OBJ//Assignment03//stone5.obj");
	//meshList[GEO_ROCK5]->textureID = LoadTGA("Image//Assignment03//snowRocks.tga");

	//meshList[GEO_BASE] = MeshBuilder::GenerateOBJ("base", "OBJ//Assignment03//Base.obj");
	//meshList[GEO_BASE]->textureID = LoadTGA("Image//Assignment03//SciFi_Tex.tga");

	//meshList[GEO_DOOR_L] = MeshBuilder::GenerateOBJ("doorL", "OBJ//Assignment03//GateDoorLeft_OBJ.obj");
	//meshList[GEO_DOOR_L]->textureID = LoadTGA("Image//Assignment03//SciFi_Tex.tga");

	//meshList[GEO_DOOR_R] = MeshBuilder::GenerateOBJ("doorR", "OBJ//Assignment03//GateDoorRight_OBJ.obj");
	//meshList[GEO_DOOR_R]->textureID = LoadTGA("Image//Assignment03//SciFi_Tex.tga");
...
void Assignment03::renderArea1Rocks()
{
	//Render Walls 
	//Left
	modelStack.PushMatrix();
...
void Assignment03::DebugCamPosition()
{
